...
app.ConcertView = Backbone.View.extend({
    ...
    template: _.template( $('#concert_template').html() ),
    ...
    render: function() {
    	...
    	// GET DATE
    	var concert_date = moment(this.model.attributes.acf.concert_date),
    		formatted_date;
    	...
    	// TMP!! – FIND A WAY TO USE SET()

    	this.model.attributes.acf.concert_date = formatted_date;
